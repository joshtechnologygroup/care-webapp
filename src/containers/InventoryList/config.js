...
export const CONFIG = {
  columnDefs: [
    { headerName: 'Faciltiy Name', field: 'facilityName', minWidth: 350 },
    { headerName: 'Type', field: 'type', minWidth: 100 },
    { headerName: 'Required #', field: 'requiredNo', minWidth: 90, editable: true,  onCellValueChanged: (data)=>{console.log('on cell change', data)} },
    { headerName: 'Current #', field: 'currentNo', minWidth: 90, editable: true,  onCellValueChanged: (data)=>{console.log('on cell change', data)} },
    { headerName: 'Updated At', field: 'updatedAt', cellRenderer: 'dateRenderer' },
