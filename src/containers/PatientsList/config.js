...
export const CONFIG = {
  columnDefs: [
    { headerName: 'ICMR ID', field: 'idICMR', cellRendererParams: { isSortable: true, filterType: 'boolean' } },
    { headerName: 'Govt. ID', field: 'idGovt', cellRendererParams: { isSortable: true, filterType: 'number' } },
    { headerName: 'Facility ID', field: 'idFacility', minWidth: 100, cellRendererParams: { isSortable: true, filterType: 'date' } },
    ...
    { headerName: 'COVID-19 Status', field: 'covidStatus', minWidth: 135, cellRendererParams: { filterType: 'boolean' } },
